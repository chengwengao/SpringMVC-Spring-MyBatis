...
<head>
    ...
    <style>
        ...
        .btnPrice {
            ...
            height: 16px;
            margin: 0px auto;
            background: url(<%=path %>/mmGrid/examples/img/botton_g1.gif) no-repeat;
        }

        .btnPrice:hover {
            background: url(<%=path %>/mmGrid/examples/img/botton_g2.gif) no-repeat;
        }


    </style>
    <!--[if lt IE 9]>
    <script src="<%=path %>/mmGrid/js/vendor/html5shiv.js"></script>
    <script src="<%=path %>/mmGrid/js/vendor/css3-mediaqueries.js"></script>
    <![endif]-->
...
<script src="<%=path %>/mmGrid/examples/js/main.js"></script>
<script>
</script>
</body>
</html>
